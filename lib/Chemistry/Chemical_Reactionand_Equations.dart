...
/*
--- Assumed MCQ Model (mcq_model.dart) ---
(Keep your MCQ model definition here or in the separate file as before)
class MCQ { ... }
--- End of Assumed MCQ Model ---
*/

class ChemicalReactionandEquations extends StatefulWidget {
  // Using hardcoded path/title for simplicity in this example
  const ChemicalReactionandEquations({Key? key}) : super(key: key);

  @override
  State<ChemicalReactionandEquations> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<ChemicalReactionandEquations> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/Chemistry/ChemicalReactionandEquations.json'; // Path to the MCQ data
  final String _chapterTitle = "Chemical Reactions and Equations"; // Title displayed in the app bar
