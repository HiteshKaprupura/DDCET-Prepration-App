...
class Metals_and_Non_Metals extends StatefulWidget {
  // Using hardcoded path/title for simplicity in this example
  const Metals_and_Non_Metals({Key? key}) : super(key: key);

  @override
  State<Metals_and_Non_Metals> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<Metals_and_Non_Metals> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/Chemistry/Metals_and_Non-Metals.json'; // Path to the MCQ data
  final String _chapterTitle = "Metals and Non-Metals"; // Title displayed in the app bar
