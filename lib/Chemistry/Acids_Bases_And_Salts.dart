...
class AcidsBasesAndSalts extends StatefulWidget {
  // Using hardcoded path/title for simplicity in this example
  const AcidsBasesAndSalts({Key? key}) : super(key: key);

  @override
  State<AcidsBasesAndSalts> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<AcidsBasesAndSalts> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/Chemistry/Acids_Bases_and_Salts.json'; // Path to the MCQ data
  final String _chapterTitle = "Acids, Bases, and Salts"; // Title displayed in the app bar
