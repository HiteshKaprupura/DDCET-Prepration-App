...
class EnvironmentalSci extends StatefulWidget {
  // Using hardcoded path/title for simplicity in this example
  const EnvironmentalSci({Key? key}) : super(key: key);

  @override
  State<EnvironmentalSci> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<EnvironmentalSci> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/EnvironmentalScience/Environmental.json'; // Path to the MCQ data
  final String _chapterTitle = "Environmental Science"; // Title displayed in the app bar
