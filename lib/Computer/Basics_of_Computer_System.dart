...
class BasicsOfComputerSystem extends StatefulWidget {
  // Using hardcoded path/title for simplicity in this example
  const BasicsOfComputerSystem({Key? key}) : super(key: key);

  @override
  State<BasicsOfComputerSystem> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<BasicsOfComputerSystem> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/Computer/basics_of_computer_system.json'; // Path to the MCQ data
  final String _chapterTitle = "Basics Of Computer System"; // Title displayed in the app bar
