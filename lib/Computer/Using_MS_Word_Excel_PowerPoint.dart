...
class UsingMsWordExcelPowerpoint extends StatefulWidget {
  // Using hardcoded path/title for simplicity in this example
  const UsingMsWordExcelPowerpoint({Key? key}) : super(key: key);

  @override
  State<UsingMsWordExcelPowerpoint> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<UsingMsWordExcelPowerpoint> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/Computer/MS_Word_Excel_PowerPoint.json'; // Path to the MCQ data
  final String _chapterTitle = "Using MS Word, Excel, and PowerPoint"; // Title displayed in the app bar
