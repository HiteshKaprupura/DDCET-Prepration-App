...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  ...
  final String _jsonPath = 'assets/mcqs/physics/chapter_1.json'; // Path to the MCQ data
  final String _chapterTitle = "Units & Measurement"; // Title displayed in the app bar
