...
class Chapter_5 extends StatefulWidget {
  // Using hardcoded path/title for simplicity in this example
  const Chapter_5({Key? key}) : super(key: key);

  @override
  State<Chapter_5> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<Chapter_5> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/physics/chapter_5.json'; // Path to the MCQ data
  final String _chapterTitle = "Wave Motion,Optics,Acoustics"; // Title displayed in the app bar
