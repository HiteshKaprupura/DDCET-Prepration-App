...
class Chapter_4 extends StatefulWidget {
  ...
  @override
  State<Chapter_4> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<Chapter_4> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/physics/chapter_4.json'; // Path to the MCQ data
  final String _chapterTitle = "Heat & Thermometry"; // Title displayed in the app bar
