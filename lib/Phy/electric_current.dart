...
class Chapter_3 extends StatefulWidget {
  ...
  @override
  State<Chapter_3> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<Chapter_3> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/physics/chapter_3.json'; // Path to the MCQ data
  final String _chapterTitle = "Electric Current"; // Title displayed in the app bar
