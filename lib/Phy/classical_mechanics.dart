...
class Chapter_2 extends StatefulWidget {
  ...
  @override
  State<Chapter_2> createState() => _QuizScreenState();
}

class _QuizScreenState extends State<Chapter_2> with TickerProviderStateMixin {
  // --- Core Quiz State ---
  ...
  final String _jsonPath = 'assets/mcqs/physics/chapter_2.json'; // Path to the MCQ data
  final String _chapterTitle = "Classical Mechanics"; // Title displayed in the app bar
